# Bluebell Cat Codex 宠物

Bluebell 是一只 Codex 自定义宠物，基于我的猫“乖乖”制作。乖乖是一只蓝眼睛重点色双色长毛猫，有深色面罩、白色鼻梁、粉色鼻子和蓬松胸毛。

这个仓库提供的是一个可以直接安装的 Codex v2 宠物包。发布内容包含一张已授权公开展示的乖乖参考照片，但不包含其他原始猫咪照片、临时生成文件、本地缓存或失败实验版本。

![Bluebell 挥爪预览](previews/waving.gif)

## 参考原型

这是我的猫“乖乖”，本宠物基于乖乖的外观制作：
...
除 `previews/guai-guai-reference.jpeg` 这张已授权公开展示的乖乖参考照片外，本仓库刻意排除了以下文件：
...
Bluebell 是非官方自定义宠物，不是 Codex 或 OpenAI 官方资产。
